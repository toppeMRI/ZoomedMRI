...
[b1,gx,gy,gz,projIm,M_bloch,K_pro] = kb_randomPerturb(d,b0map,sens, mask,tipangle,n_pe,ishard,simuRange,tol,extype,isBssfp);
...
nrmse_all(irun) = nrmse;
end
save nrmse_randomPerturb nrmse_all; 
