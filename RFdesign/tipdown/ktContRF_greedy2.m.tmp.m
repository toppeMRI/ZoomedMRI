function [b1,gx,gy,gz,projIm,M_pr,K_rv] = ktContRF_greedy2(d,fieldmap,sens, mask,tipangle,n_pe,ishard,xyzRange,tol,extype,isBssfp)
...
fprintf(1,'\n');
if strcmp(reply,'y')   % JFN set to 1 to run the interior-point optimization. Set to 0 to generate IV pulse for rFOV paper
   ndt = 1;
   load weighting;
   K_rv_old = K_rv;
   k = K_rv(1:ndt:end,:);
