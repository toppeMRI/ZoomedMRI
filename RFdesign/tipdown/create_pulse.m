function [b1,gx,gy,gz] = create_pulse(x_est,n_pulse_seg,ncoils,kx,ky,pulse_params,dx,dy,sx,sy,ishard)
% b1 is in tesla
...
if ishard ~= 1
 ...
 [b1,gx,gy,gz]=full_pulse_gen_hard(tip_angle,slice_thickness,a_kx,a_ky,max_pe_jump,kz_area,weights,ncoils,slew_rate,g_max,dt);
end 
