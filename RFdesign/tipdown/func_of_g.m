function [fval] = func_of_g(g_coeff, d,fmap,roi,sens,xyzRange,Trf)
...
M_pr = parallel_blochCim(0,B1,gx,gy,gz,sens,xyzRange.x,xyzRange.y,xyzRange.z,dt,fmap,roi,T1/1000,T2/1000);
M_diff = M_pr - d; 
fval = norm(M_diff(:)); 
%}
