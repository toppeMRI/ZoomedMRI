function [b1,gx,gy,gz,projIm,M_pr,K_rv] = kb_randomPerturb(d,fieldmap,sens, mask,tipangle,n_pe,ishard,xyzRange,tol,extype,isBssfp)
...
K_rv = K_rv + 0.15*randn(size(K_rv));
K_rv(end) = 0; 
G_rv = k2g_hao(K_rv); 
save test K_rv G_rv; 
