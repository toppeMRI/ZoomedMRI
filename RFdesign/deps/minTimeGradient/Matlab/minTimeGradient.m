...
[dt0, gMax0, sMax0] = envMR('get', 'dt', 'gMax', 'sMax');
if ~exist('gmax','var'), gmax = gMax0; end
if ~exist('smax','var'), smax = sMax0; end
if ~exist('T',   'var'), T = dt0*1e3;  end % mSec

% if nargin<5, gmax = 4;  end
% if nargin<6, smax = 15; end
% if nargin<7, T = 4e-3;  end
